...
class InRecycleActivity : AppCompatActivity() {
    private lateinit var binding: ActivityInRecycleBinding
    private lateinit var viewModelFactory: ViewModelFactory
    private var token = ""
    private val viewModel: InRecycleViewModel by viewModels { viewModelFactory }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityInRecycleBinding.inflate(layoutInflater)
